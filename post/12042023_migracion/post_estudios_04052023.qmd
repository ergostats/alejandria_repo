...
Queremos construir un mapa temático o *coroplético* del mundo, que indique **el número salidas de ecuatorianos mayores de 18 años por motivos de estudios**.
...
gt::gtsave(data = tabla_gt,
           filename = "tabla_10.png")

ggsave(plot = plot_resultado,
       filename = "mapa_migracion_estudios.png",
...
-   **Salidas de ecuatorianos por motivo de estudio:** Consideramos las salidas de ecuatorianos mayores de 18 años. Una misma persona puede salir más de una vez del Ecuador por motivos de estudios en un mismo año, un estudiante puede regresar al país por vacaciones.

-   **Estudiantes**: El visado por motivo de estudios depende de cada país. Tres requisitos básicos con: solicitud de visado, pasaporte valido y pruebas sobre la admisión en algún programa de estudios de manera regular, entre otros, visita la página del consulado del país al que desear ir para conocer los requisitos especificos.
